...
abstract class Model
{
    ...
    /**
     * Возвращает имя таблицы с которой связана текущая модель, имя таблицы формируется из
     * имени текущего класса. При этом CamelCase заменяется на разделение с помощью '_'
